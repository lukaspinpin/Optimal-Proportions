...
simulation <- function(N=200, dist="bern", par1 = c(0,0),  par2 = NULL, burnin=3, ar=NULL, nsim= 10^4, method="ER", measure="sd", signlevel=0.05){
  ...
  if(method=="ERADE"){
    filename <-  paste(method, ar, N, burnin,dist,"All_Table.csv",sep="_")
  } else {
    filename <-  paste(method, N, burnin, dist,"All_Table.csv",sep="_")
  }
...
# Simulations for Section 5.1 of the Paper
simulation(N=68, dist="bern", par1 = par1_Ber, nsim=nsim,  burnin=25, method = "ER", measure = "sd", signlevel = 0.05) 
simulation(N=68, dist="bern", par1 = par1_Ber, nsim=nsim, burnin=2, method = "ER", measure = "sd", signlevel = 0.05)
simulation(N=68, dist="bern", par1 = par1_Ber, nsim=nsim, burnin=2, method = "ERADE", ar="RSHIR_Z1", measure = "sd", signlevel = 0.05) #10^4
simulation(N=68, dist="bern", par1 = par1_Ber, nsim=nsim, burnin=2, method = "ERADE", ar="RSHIR_Z0", measure = "sd", signlevel = 0.05) #10^4
simulation(N=68, dist="bern", par1 = par1_Ber, nsim=nsim, burnin=2, method = "ERADE", ar="Neyman_Z1", measure = "sd", signlevel = 0.05) #10^4
simulation(N=68, dist="bern", par1 = par1_Ber, nsim=nsim, burnin=2, method = "ERADE", ar="Neyman_Z0", measure = "sd", signlevel = 0.05) #10^4